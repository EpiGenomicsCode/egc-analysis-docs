...
<Link
  ...
  href="https://github.com/CEGRcode/ChIP_general-galaxy_tools/blob/main/genetrack.py" >Download GeneTrack script</Link>

<Link
  className="button button--secondary"
  href="https://github.com/CEGRcode/ChIP_general-galaxy_tools/blob/main/cwpair2.py" >Download CWPair script</Link>
